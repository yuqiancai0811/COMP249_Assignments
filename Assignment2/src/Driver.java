...
public class Driver {
    ...
    /**
     * @param listFileName save file's names
     * @return String array of files' names
     */
    ...
    public static String[] splitCSVLine(String line) {
        ...
        for (int i = 0; i < line.length(); i++) {
            ...
            if (ch == '\"') {
                ...
                fields[currentField++] = field.toString();
                field = new StringBuilder(); // Reset the field
    ...
    //use try and catch InputMismatchException for user does not put in a integer
